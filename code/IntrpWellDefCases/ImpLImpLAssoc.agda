...
mip≗⇒L⇒L-assoc Γ Δ ._ {[]} {Γ₁} {Δ₁} {Λ₀} {Λ₁} {A} {B} {A'} {B'} refl | inj₁ (._ , refl , refl) | inj₁ (Ω₀ , refl , refl) | inj₂ (Ω₁ , refl , refl) | inj₂ (Ω₂ , refl , refl) | inj₁ ([] , refl , refl) 
...
mip≗⇒L⇒L-assoc Γ Δ ._ {[]} {Γ₁} {Δ₁} {Λ₀} {Λ₁} {A} {B} {A'} {B'} refl | inj₁ (._ , refl , refl) | inj₁ (Ω₀ , refl , refl) | inj₂ (Ω₁ , refl , refl) | inj₂ (Ω₂ , refl , refl) | inj₁ (E ∷ Ω₃ , refl , refl)
...
mip≗⇒L⇒L-assoc Γ Δ ._ {Γ₀} {Γ₁} {Δ₁} {Λ₀} {Λ₁} {A} {B} {A'} {B'} eq | inj₁ (Ω , refl , refl) | inj₂ (Ω₀ , refl , refl) | inj₁ (Ω₁ , refl , refl) | inj₁ (Ω₂ , refl , refl) = {!   !}
