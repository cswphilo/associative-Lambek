...
%  For example, if $\GD$ is contained in $\GD'$, i.e.\
  ...
  with $\vars{D} \in \vars{\GD} \cap \vars{\GD'_0, \GD'_1,A}$.
  Then $\mf{mip}\ (\GD,f) = (D,g,h')$ where $g = \Rl \ (g' , f'')$.
  The variable condition is satisfied since $\vars{D} \in \vars{\GD'_0, \GD'_1,A} \subseteq \vars{\GD'_0, \GD'_1,A\Rarr B, C}$.
%   \[
%     \begin{array}{c}
%     g = \proofbox{
...
%     \end{itemize}
 ...
 % The variable condition is easy to check.
  ...
  Case $(vi)$: $\GD$ splits between $\GD'$ and $\GL'$ and contains $A \Rarr B$. Then $\GD'$ has the form $\GD'_0 , \GD'_1$ and $\GL'$ has the form $\GL'_0 , \GD'_1$ so that $\GD = \GD'_1 , A \Rarr B , \GL'_0$.
...
%  $\GD$ splits between $\GG'$ and $\GD'$, then $\GG'$ has the form $\GG'_0 , \GG'_1$ and $\GD'$ has the form $\GD'_0 , \GD'_1$ so that $\GD = \GG'_1 , \GD'_0$.
  ...
  \item formulae $D_1,\dots,D_n$,
  \item a derivation $g' : D_1,\dots,D_n , \GD'_1 \vd A$,
  \item derivations $h'_i : \GD'_{0_i} \vdash D_i$ for $\in \{1,\dots,n\}$ such that
  \item $\vars{D_1 , \dots, D_n} \subseteq \vars{\GD'_0} \cap \vars{\GD'_1, A}$
  \end{itemize}
  \begin{itemize}
