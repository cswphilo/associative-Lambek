...
% In other words, the interpolation procedure is a right inverse of the admissible cut, up to $\circeq$.
...
In \cite{VW2025Tableaux}, Veltri and Wan also raised the question of \emph{well-definedness} of the Maehara interpolation procedure.
...
% \label{fig:conv}
% \end{figure}
The admissible cut rule is proved to satisfy a number of equivalences (\agdaref{CutProperties.agda\#L258}), stating that $\cut$ commutes with left introduction rules in the first premise up to $\circeq$, e.g.
